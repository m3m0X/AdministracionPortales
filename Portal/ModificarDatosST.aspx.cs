        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    {
                        txtuser.Focus();
                        MySqlCommand scSqlCommand = new MySqlCommand("SELECT descripcion FROM " + bd1 + ".Options_Menu WHERE url = 'ModificarDatosST.aspx' and Tipoportal = 'A'", Conexion.ObtenerCnMysql());
