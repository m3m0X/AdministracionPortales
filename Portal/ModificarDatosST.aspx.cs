...
{
    public partial class ModificarDatosST : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    {
                        txtuser.Focus();
                        MySqlCommand scSqlCommand = new MySqlCommand("SELECT descripcion FROM basica_trabajador.Options_Menu WHERE url = 'ModificarDatosST.aspx' and Tipoportal = 'A'", Conexion.ObtenerCnMysql());
