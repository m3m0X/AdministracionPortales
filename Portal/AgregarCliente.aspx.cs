    ...
    public partial class AgregarCliente : System.Web.UI.Page
    {
            ...
            else
            {
                if (!IsPostBack)
                {
                    ...
                    try
                    {
                        ...
                        MySqlCommand scSqlCommand = new MySqlCommand("SELECT descripcion FROM basica_trabajador.Options_Menu WHERE url = 'AgregarCliente.aspx' and Tipoportal = 'A'", Conexion.ObtenerCnMysql());
        ...
        protected void BtnBuscar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (BtnBuscar.Text == "Nueva Búsqueda")
                {
                    ...
                    TxtCorreoTercero.Enabled = true;
                    TxtCorreoTercero.BackColor = System.Drawing.Color.White;
                    ...
                    this.listActivo.Enabled = true;
                    this.listActivo.BackColor = System.Drawing.Color.White;

                    LblPass.Visible = false;
                    TxtPass.Visible = false;
                    BtnPass.Enabled = true;
                    BtnPass.Visible = true;
                    BtnPass.BackColor = default(System.Drawing.Color); 
                }
                else
                {
        ...
        public void CargarInfoCliente(string Nit_tercero)
        {
            ...
            try
            {
                ...
                if (rd.Read())
                {
                    ...
                    TxtCorreoTercero.Text = rd["Correo_tercero"].ToString();
                    Session.Add("Contrasena", rd["Contrasena_Tercero"].ToString());
                    TxtPass.Text = "";
                    BtnEditar.Text = "Guardar Información";
                    this.listActivo.SelectedValue = rd["Activo_Tercero"].ToString();
                }
                else
                {
        ...
        protected void ValidatorPass_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            else
            {
                ...
                try
                {
                    MySqlCommand scSqlCommand = new MySqlCommand("SELECT Contrasena_tercero FROM trabajadores.terceros where Nit_tercero =" + txtuser.Text, Conexion.ObtenerCnMysql());
                    MySqlDataAdapter sdaSqlDataAdapter = new MySqlDataAdapter(scSqlCommand);
                    DataSet dsDataSet = new DataSet();
                    DataTable dtDataTable = null;
        ...
        protected void BtnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (BtnEditar.Text == "Insertar Cliente")
            {
                ...
                TxtCorreoTercero.Enabled = false;
                TxtCorreoTercero.BackColor = System.Drawing.Color.LightGray;
                ...
                this.listActivo.Enabled = false;
                this.listActivo.BackColor = System.Drawing.Color.LightGray;
        ...
        {
            int R = ActualizaInfoTercero(txtuser.Text);
            if (R == 1)
            {
        ...
        public int ActualizaInfoTercero(string Nit_tercero)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@direccion", TxtDir.Text.ToUpper());
                cmd.Parameters.AddWithValue("@correo", TxtCorreoTercero.Text);
                cmd.Parameters.AddWithValue("@Activo", SqlDbType.Bit).Value = this.listActivo.SelectedValue;
        ...
        #region Metodo BtnInsertar_Click
        /* ****************************************************************************/
        /* Evento que se produce al dar clic sobre el boton BtnInsertar para agregar un nuevo cliente
        /* ****************************************************************************/
        protected void BtnInsertar_Click(object sender, EventArgs e)
        {
            ...
            RequiredContrasena.Visible = true;
            ValidatorPass.Visible = true;
            this.listActivo.SelectedValue = "1";

            Session["cambiaContrasena"] = true;
            TxtNombres.Focus();
            BtnEditar.Text = "Insertar Cliente";
            UpdatePanel1.Update();
        }
        #endregion
        ...
        public int CrearTercero()
        {
            ...
            {
                Conexion.AbrirCnMysql();
                MySqlCommand cmd = new MySqlCommand("trabajadores.sp_CrearTercero", Conexion.ObtenerCnMysql());
                cmd.CommandType = CommandType.StoredProcedure;
