<%@ Page Title="" Language="C#" MasterPageFile="~/Portal/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="ModificarDatosAE.aspx.cs" Inherits="PortalTrabajadores.Portal.ModificarDatosAE" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <div id="Container_UpdatePanel1">
                <table id="TablaDatos">
                    <tr>
                        <th colspan="2">Módulo de Modificación de Datos a Trabajadores</th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="BotonTablaDatos">
                                <asp:Button ID="BtnBuscar" runat="server" Text="Buscar Trabajador" OnClick="BtnBuscar_Click" />
                        </td>
                    </tr>
                </table>
            </div>
            <div id="Container_UpdatePanel2" runat="server" visible ="false">
                <table id="TablaDatos2">
                    ...
                    <tr class="ColorOscuro">
                        ...
                        <td><asp:TextBox ID="TxtExp" runat="server" MaxLength="45" onkeypress="return ValidaSoloLetras(event)" Style="text-transform: uppercase"/></td>
                    </tr>
                    <tr>
                        <td><asp:Label ID="LblFechNac" runat="server" Text="Fecha Nacimiento:" /></td>
                        <td><asp:TextBox ID="TxtFechNac" runat="server" />
