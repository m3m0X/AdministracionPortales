...
namespace PortalTrabajadores.Portal
{
    public partial class login : System.Web.UI.Page
    {
        ...
        protected void btnlogin_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                MySqlCommand scSqlCommand = new MySqlCommand("SELECT Id_Empleado, Id_Rol, Nombres_Empleado FROM trabajadores.empleados where Id_Empleado = '" + this.txtuser.Text + "' and Contrasena_Empleado = '" + this.txtPass.Text + "' and  Id_Rol = 4;", Conexion.ObtenerCnMysql());
