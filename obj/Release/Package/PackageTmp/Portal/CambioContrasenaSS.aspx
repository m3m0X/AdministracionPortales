<%@ Page Title="" Language="C#" MasterPageFile="~/Portal/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="CambioContrasenaSS.aspx.cs" Inherits="PortalTrabajadores.Portal.CambioContrasenaSS" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div id="Container_UpdatePanel1">
                <table id="TablaDatos">
                    <tr>
                        <th colspan="2">Módulo de Reseteo de Contraseña Trabajadores</th>
                    </tr>
                    <tr>
